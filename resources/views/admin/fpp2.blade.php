...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Set Tanggal FPP 2<small></small></h2>
      ...
      <div class="x_content">
        ...
        <form action="{{action('FPP2Controller@update', $post['id'])}}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
        ...
        <form action="{{url('fpp2')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
